...
int main(){
    ...
    tc{ int n;
        ...
        cin>>s;
        // rrep(i,n-1,0){
        //     if((s[i]-'0')%2==0) s.erase(i);
        //     else break;
        // }
        // if(s=="") cout<<-1<<endl;
        // else{
        //     int n=s.length(),ans=0,idx=-1;
        //     rep(i,0,n){
        //         if((s[i]-'0')%2==1) {ans++;idx=i;}
        //     }
        //     if(ans%2==1){
        //         s.erase(idx);
        //         if(s=="" ) cout<<-1<<endl;
        ...
        int idx1=-1,idx2=-1;
        rep(i,0,n){
            if((s[i]-'0')%2==1 && idx1==-1) idx1=i;
            else if((s[i]-'0')%2==1 && idx2==-1) idx2=i;
        }
        if(idx1==-1 || idx2==-1) cout<<-1<<endl;
        else cout<<s[idx1]<<s[idx2]<<endl;
    }
}